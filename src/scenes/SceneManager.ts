...
// TODO: Only draw entites that are within view of the camera (centered on the player usually), plus a little leeway to allow moving entities that could potentially move into view to continue updating
